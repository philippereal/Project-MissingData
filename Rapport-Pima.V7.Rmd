...
imp.mipca.bayes.new <-MIPCA(new.data[,1:maxDim],ncp=ncp.res.new,verbose=TRUE, method.mi = "Bayes", nboot=100)
...
Au regard des différentes comparaisons et du test ANOVA final, on conserve un modèle excluant les variables : bmi,glu,npreg <= NOK?
On aurait tendance à rejetter les variables skin, bp et age.
